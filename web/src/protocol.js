...
// ROLE payload: role, feature bits, then the little-endian u64 control tenure. Feature bits: bit 0 the microphone, bit 1 the webcam, bit 2 session playback available
